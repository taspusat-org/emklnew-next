...
import Form from '../FormBiayaExtraHeader';
import { biayaExtraHeaderSchema } from '@/lib/validations/biayaextraheader.validation';
import {
  renderForm,
  getBtn,
  saveButton,
...
const schema = biayaExtraHeaderSchema;
const validData = buildValidObject(schema);

describe('FormBiayaExtraHeader', () => {
